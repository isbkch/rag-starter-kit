...
class CacheService:
    ...
    async def get_embedding(
        ...
        if embedding:
            ...
            get_metrics_collector().record_cache_operation('get', 'embedding', success=True)
            return embedding
    ...
    async def set_embedding(
        ...
        if success:
            ...
            from app.core.metrics import get_metrics_collector
            get_metrics_collector().record_cache_operation('set', 'embedding', success=True)
    ...
    async def get_search_results(
        ...
        if results:
            ...
            # Record cache hit metric
            from app.core.metrics import get_metrics_collector
            get_metrics_collector().record_cache_operation('get', 'search', success=True)
    ...
    async def set_search_results(
        ...
        if success:
            ...
            # Record cache operation metric
            from app.core.metrics import get_metrics_collector
            get_metrics_collector().record_cache_operation('set', 'search', success=True)
    ...
    async def set_vector_stats(self, provider: str, collection: str, stats: Dict) -> bool:
