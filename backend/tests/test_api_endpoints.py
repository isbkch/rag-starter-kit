...
class TestDocumentEndpoints:
    ...
    @patch("app.services.ingestion.document_processor.DocumentProcessor.process_document")
    ...
    @patch("app.services.ingestion.document_processor.DocumentProcessor.delete_document")
    ...
    def test_delete_document_not_found(self, client: TestClient):
        ...
        with patch("app.services.ingestion.document_processor.DocumentProcessor.delete_document") as mock_delete:
...
class TestAPIIntegration:
    ...
    def test_full_document_workflow(self, client: TestClient):
        ...
        with patch("app.services.ingestion.document_processor.DocumentProcessor") as mock_processor_class:
            with patch("app.services.search.search_manager.SearchManager") as mock_search_class:
                ...
                found_doc = next(
                    (r for r in search_data["results"] if r["id"] == document_id),
                    None
                )
...
class TestAPIPerformance:
    ...
    def test_search_response_time(self, client: TestClient, performance_threshold):
        ...
        with patch("app.services.search.search_manager.SearchManager.search") as mock_search:
            mock_search.return_value = {
                "results": [],
                "total": 0,
                "query_time": 0.05
